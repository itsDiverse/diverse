...
export default props => (
  <div styleName="content-wrapper">
    <div styleName="going-about-20-minutes">
      <div styleName="container-lg">
        <div styleName="going-about-20-minutes-box">
          <div styleName="left-box-content about-minutes-title">
            <h2>Get going in about 20 minutes</h2>
            <p>
              We guide you through the essentials and handle the rest. Fill out
              a bit of information, which takes about 20 minutes, and then we’ll
              begin creating the legal framework for your company.
            </p>
            <ul styleName="about-minutes-box-list">
              <li>
                <figure styleName="icon">
          ...
          <div styleName="right-box-content">
            <figure styleName="devices-dashboard loaded">
              <div styleName="ground">
                <div styleName="shadow"></div>
              </div>
              <div styleName="laptop">
                <div styleName="device"></div>
                <div styleName="controls"></div>
                <div styleName="screen country-IN"></div>
              </div>
            </figure>
          </div>
        </div>
        <div styleName="going-about-20-minutes-box">
          <div styleName="left-box-content">
            <ul styleName="about-minutes-box-list">
              <li>
                <figure styleName="icon">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                ...
                <p>
                  ...
                  bank account. Start conducting business with your Stripe Atlas
                  company, without ever having to visit a branch in person.{" "}
                </p>
              </li>
            </ul>
          </div>
          <div styleName="right-box-content">
            <ul styleName="about-minutes-box-list">
              <li>
                ...
                <p>
                  Activate your Stripe account to start accepting payments from
                  customers in 100+ currencies. You can also take advantage of a
                  range of Stripe’s other products, including{" "}
