...
export default props => (
  <div styleName="contentWrapper">
    <div styleName="paymentsStackSection">
      <div styleName="containerLg">
        <div styleName="paymentsStackSectionIntro">
          <h2 styleName="sectionTitle">The new payments stack</h2>
          <p styleName="sectionDesc">
            Stripe combines a payments platform with applications that put
            revenue data at the heart of business operations.
          </p>
        </div>
        <div styleName="diagramPlatforms diagram">
          <div styleName="diagramApps diagramSection animated fadeInLeft ">
            <a href="#" styleName="diagramProduct diagramProductRadar">
            ...
            <a href="#" styleName="diagramProduct diagramProductSigma">
              <svg viewBox="0 0 48 48">
                <path
                  styleName=""
            ...
            <a href="#" styleName="diagramProduct diagramProductBilling">
              <svg viewBox="0 0 48 48">
                <path
                  fill="#74E4A2"
                  styleName=""
            ...
            <a href="#" styleName="diagramProduct diagramProductAtlas">
              <svg viewBox="0 0 48 48">
                <path
                  fill="#FCD669"
                  styleName=""
          ...
          <div styleName=" animated fadeInRight">
            <h4 styleName="uppercaseText diagramTitle">Applications</h4>
            <p styleName="diagramDesc">
              Sitting atop our payments platform are applications to manage
              revenue, prevent fraud, and expand internationally.
            </p>
          </div>
          <div styleName="diagramPlatforms diagramSection animated delay06s left15 fadeInLeft">
            <a href="#" styleName="diagramProduct diagramProductPayments">
              <svg viewBox="0 0 48 48">
                <path
                  fill="#87BBFD"
                  styleName=""
            ...
            <a href="#" styleName="diagramProduct diagramProductConnect">
              <svg viewBox="0 0 48 48">
                <path
                  fill="#68D4F8"
                  styleName=""
          ...
          <div styleName="diagramPlatformsContent diagramContent animated delay06s right15 fadeInRight">
            <h4 styleName="uppercaseText diagramTitle">Payments platform</h4>
            <p styleName="diagramDesc">
              At our core is a powerful payments engine that makes moving money
              easy.
            </p>
          </div>
          <div styleName="diagramInfra diagramSection jsDiagram animated fadeInLeft delay03s left10">
            <div styleName="diagramInfraService" aria-hidden="true"></div>
            <div styleName="diagramInfraService" aria-hidden="true"></div>
            <div styleName="diagramInfraService" aria-hidden="true"></div>
            <div styleName="diagramInfraService" aria-hidden="true"></div>
            <div styleName="diagramInfraService" aria-hidden="true"></div>
          ...
          <div styleName="diagramInfraContent diagramContent jsDiagramExplanation animated fadeInRight delay03s right10">
            <h4 styleName="uppercaseText diagramTitle">Infrastructure</h4>
            <p styleName="diagramDesc">
