...
export default props => (
  <StyledContentWrapper theme={props.theme}>
    <div className="contentWrapper">
      <div className="paymentsStackSection">
        <div className="containerLg">
          <div className="paymentsStackSectionIntro">
            <h2 className="sectionTitle">The new payments stack</h2>
            <p className="sectionDesc">
              Stripe combines a payments platform with applications that put
              revenue data at the heart of business operations.
            </p>
          </div>
          <div className="diagramPlatforms diagram">
            <div className="diagramApps diagramSection animated fadeInLeft ">
              <a href="#" className="diagramProduct diagramProductRadar">
              ...
              <a href="#" className="diagramProduct diagramProductSigma">
                <svg viewBox="0 0 48 48">
                  <path
                    className=""
              ...
              <a href="#" className="diagramProduct diagramProductBilling">
                <svg viewBox="0 0 48 48">
                  <path
                    fill="#74E4A2"
                    className=""
              ...
              <a href="#" className="diagramProduct diagramProductAtlas">
                <svg viewBox="0 0 48 48">
                  <path
                    fill="#FCD669"
                    className=""
            ...
            <div className=" animated fadeInRight">
              <h4 className="uppercaseText diagramTitle">Applications</h4>
              <p className="diagramDesc">
                Sitting atop our payments platform are applications to manage
                revenue, prevent fraud, and expand internationally.
              </p>
            </div>
            <div className="diagramPlatforms diagramSection animated delay06s left15 fadeInLeft">
              <a href="#" className="diagramProduct diagramProductPayments">
                <svg viewBox="0 0 48 48">
                  <path
                    fill="#87BBFD"
                    className=""
              ...
              <a href="#" className="diagramProduct diagramProductConnect">
                <svg viewBox="0 0 48 48">
                  <path
                    fill="#68D4F8"
                    className=""
            ...
            <div className="diagramPlatformsContent diagramContent animated delay06s right15 fadeInRight">
              <h4 className="uppercaseText diagramTitle">Payments platform</h4>
              <p className="diagramDesc">
                At our core is a powerful payments engine that makes moving
                money easy.
              </p>
            </div>
            <div className="diagramInfra diagramSection jsDiagram animated fadeInLeft delay03s left10">
              <div className="diagramInfraService" aria-hidden="true"></div>
              <div className="diagramInfraService" aria-hidden="true"></div>
              <div className="diagramInfraService" aria-hidden="true"></div>
              <div className="diagramInfraService" aria-hidden="true"></div>
              <div className="diagramInfraService" aria-hidden="true"></div>
            ...
            <div className="diagramInfraContent diagramContent jsDiagramExplanation animated fadeInRight delay03s right10">
              <h4 className="uppercaseText diagramTitle">Infrastructure</h4>
              <p className="diagramDesc">
