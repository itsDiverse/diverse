...
import complianceImg from "./images/compliance.svg"
import internationalImg from "./images/international-support.svg"
import platformImg from "./images/platform-management.svg"
                ...
                <section className="dashboard-connected-accounts">
                  ...
                  <div className="connected-accounts-view">
                    <ul className="connected-accounts-subnav">
                      <li className="active">Connected accounts</li>
                    ...
                    <section className="connected-accounts-upcoming">
                      ...
                      <ul>
                        <li>
                          ...
                          acct_19RLGo12b5oAam
                          <span className="state-badge">Upcoming due</span>
                        </li>
                        <li>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <section className="connected-accounts-recent">
                      ...
                      <ul>
                        <li>
                          ...
                          acct_426klopma25kaa
                          <span className="state-badge">Verified</span>
                        </li>
                        <li>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        <li>
                          ...
                          acct_104KvnwQYOP341
                          <span className="state-badge">Unverified</span>
                        </li>
                      </ul>
                    </section>
                  </div>
