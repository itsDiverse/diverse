...
import style from "./Module7.module.css"
    ...
    <div className={"contentWrapper"}>
      <div className={style.complianceSection}>
        <div className={"containerLg"}>
            ...
            <div className={style.complianceContent}>
              <div className={style.complianceLeftContent}>
                <p>
                  ...
                  <a href="#" className={style.commonLink}>
                    marketplace
                  </a>{" "}
                  or{" "}
                  <a href="#" className={style.commonLink}>
                  ...
                  issues such as card network rules, money transmission, KYC,
                  and tax reporting. Connect makes these burdens easier to
                  manage by shifting some of the most onerous obligations to
                  Stripe, letting you stay focused on your product and spend
                  less time on compliance related tasks.
                </p>
                <p>
          ...
          <div className={style.platformManagementSection}>
            <div className={style.platformManagementLeftContent}>
              ...
              <p>
                ...
                a hub for all the workflows involved. Our dashboard lets support
                and operations teams view every stage of the user lifecycle:
                account history, verification, transfers, and more.
              </p>
              <p>
            ...
            <div
              className={[
                style.platformManagementRightContent,
                style.laptop,
              ].join(" ")}
            >
              ...
              <div className={style.screen}>
                <section className={style.dashboardConnectedAccounts}>
                  <div className={style.connectedAccountsNav}>
                    <h1>Kosa Commerce</h1>
                    <ul>
                      <li>Home</li>
                      <li>Payments</li>
                  ...
                  <div className={style.connectedAccountsView}>
                    <ul className={style.connectedAccountsSubnav}>
                    ...
                    <section className={style.connectedAccountsUpcoming}>
                    ...
                    <section className={style.connectedAccountsRecent}>
          ...
          <div className={style.internationalSupport}>
            ...
            <div className={style.internationalSupportRightContent}>
              <aside>
                ...
                <ul className={style.settlementCurrencies}>
                  <li>EUR</li>
                  <li>USD</li>
                  <li>NOK</li>
                  <li>HKD</li>
