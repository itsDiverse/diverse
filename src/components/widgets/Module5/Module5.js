            ...
            <div className="footer-cards">
              <div className="footer-cards-wrapper">
                <a href="#">
                  ...
                  <h3 className="link-arrow">Explore the docs</h3>
                  <p>
              ...
              <div className="footer-cards-wrapper">
                <a href="#">
                  ...
                  <h3 className="link-arrow">Pricing</h3>
                  <p>
          ...
          <div className="container-lg">
            <div className="get-in-touch-content-wrapper">
              ...
              <div className="get-in-touch-btn">
                <a className="btn-left btn-default" href="#">
                  Contact Sales
                </a>
                <a className="btn-right btn-default" href="#">
                  Create Account
                </a>
              </div>
            </div>
            <p>Connect Payouts is available for platforms based in the US.</p>
          </div>
        </section>
      </div>
    </div>
