...
import style from "./Module5.module.css"
          ...
          <div className={"containerLg"}>
            <div className={style.getInTouchContentWrapper}>
              ...
              <div className={style.getInTouchBtn}>
                <a
                  className={(style.btnLeft, style.btnDefault)}
                  style={{
                    color: props.button1textColor,
                    backgroundColor: props.button1color,
                  }}
                  href="#"
                >
                  {props.button1title}
                ...
                <a
                  className={(style.btnRight, style.btnDefault)}
                  style={{
                    color: props.button2textColor,
                    backgroundColor: props.button2color,
                  }}
                  href="#"
                >
                  {props.button2title}
