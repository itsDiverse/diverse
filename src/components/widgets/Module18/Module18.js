...
export default props => (
  <div styleName="content-wrapper">
    <div styleName="regulatory-compliance-section">
      <div styleName="container-lg">
        <div styleName="regulatory-compliance-title">
          <span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
              <rect width="48" height="48" styleName="fill-none"></rect>
              <path
                d="M24,5s7,5,15,5V21c0,16-13,22-15,22S9,37,9,21V10C17,10,24,5,24,5Z"
                styleName="fill-purple"
              ></path>
              <path
        ...
        <div styleName="regulatory-compliance-checklist">
          <div styleName="check-list checklist-left">
          ...
          <div styleName="check-list checklist-right">
            ...
            <ul>
              ...
              <li>
                ...
                <span>1099 reporting support (IRS tax threshold tracking)</span>
              </li>
              <li>
                <span>
                  <svg
