		...
		<div className={style.solutionsRootedSection}>
			<div className={style.containerLg}>
			    <div className={style.sectionIntro}>
					<h2 className={style.sectionTitle}>Solutions rooted in code and design</h2>
			  		<p className={style.sectionDesc}>As the world’s fastest-advancing developer platform, Stripe gives businesses the tools and technology to build better.</p>
				</div>
				<div className={style.solutionsRootedContent}>
				  <div className={style.rootedContentLeft}>
				      <div className={[style.rootedBox, style.rootedBoxDocumentation].join(' ')}>
				        ...
				        <h4 className={style.rootedTitle}>Industry-leading documentation</h4>
				        <p className={style.rootedDesc}><a href="#" className={style.commonLink}>Our documentation</a> and extensive Client libraries contain everything a business needs to build a custom integration in a fraction of the time.</p>
				      </div>
				      <div className={[style.rootedBox, style.rootedBoxOss].join(' ')}>
				        ...
				        <h4 className={style.rootedTitle}>Support for the developer community</h4>
				        <p className={style.rootedDesc}>We actively contribute to <a href="#" className={style.commonLink}>open-source projects</a>—giving back to the community through development, patches, and sponsorships.</p>
				      </div>
				      <div className={[style.rootedBox, style.rootedBoxWorksWith].join(' ')}>
				        ...
				        <h4 className={style.rootedTitle}>Thriving partner ecosystem</h4>
				        <p className={style.rootedDesc}>Our <a href="#" className={style.commonLink}>Works with Stripe</a> library offers hundreds of third-party integrations to help with business operations, including analytics, accounting, CRM and shipping.
				        </p>
				      </div>
				  </div>
				  <div className={style.rootedContentRight}>
				    <aside className={[style.engineeringScale, style.commonCard].join(' ')}>
				      ...
				      <h2 className={style.engineeringScaleTitle}>Engineering at scale</h2>
				      <p className={style.engineeringScaleDesc}>We publish <span className={style.uItalic}>Increment</span>, an engineering magazine dedicated to sharing insights and practical advice for building and operating software systems at scale.</p>
				      <a href="#" target="_blank" className={[style.btnEngineering, style.btnCommon].join(' ')} data-analytics-action="visit_increment" data-analytics-source="increment_cta">
				        Visit Increment
				      </a>
				    </aside>
				  </div>
