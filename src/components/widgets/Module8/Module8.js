            ...
            <ul className="onetime-lifetime-list">
              <li>
                <div>
                  ...
                  >
                    <g fill="none" fill-rule="evenodd">
                      <circle fill="#FF9B7C" cx="14" cy="14" r="14"></circle>
                      <path
              ...
              <li>
                <div>
                  ...
                  >
                    <g fill="none" fill-rule="evenodd">
                      <circle cx="14" cy="14" r="14" fill="#FF9B7C"></circle>
                      <path
            ...
            <ul className="onetime-lifetime-list">
              ...
              <li>
                <div>
                  ...
                  >
                    <g fill="none" fill-rule="evenodd">
                      <circle fill="#FF9B7C" cx="14.5" cy="14" r="14"></circle>
                      <path
